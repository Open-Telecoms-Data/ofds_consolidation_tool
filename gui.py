...
class Ui_OFDSDedupToolDialog(object):
    def setupUi(self, OFDSDedupToolDialog):
        ...
        self.finishedButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.finishedButton.setObjectName("finishedButton")
        self.startLayout.addWidget(self.finishedButton)
    ...
    def retranslateUi(self, OFDSDedupToolDialog):
        ...
        self.finishedButton.setText(_translate("OFDSDedupToolDialog", "Finished"))
