...
class Ui_OFDSDedupToolDialog(object):
    def setupUi(self, OFDSDedupToolDialog):
        ...
        self.outputMapCanvas.setGeometry(QtCore.QRect(10, 10, 911, 421))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.outputInfoPanel = QtWidgets.QTextEdit(self.tabOutput)
        self.outputInfoPanel.setGeometry(QtCore.QRect(10, 440, 901, 361))
        self.outputInfoPanel.setObjectName("outputInfoPanel")
        self.tabWidget.addTab(self.tabOutput, "")
        self.verticalLayout.addWidget(self.tabWidget)

        self.retranslateUi(OFDSDedupToolDialog)
        self.tabWidget.setCurrentIndex(3)
        self.outputFinishedButton.clicked.connect(OFDSDedupToolDialog.close) # type: ignore
